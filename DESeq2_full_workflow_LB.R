...
DESeq2::plotPCA(vsdLRT, intgroup = "group", ntop = 500)
ggsave(file.path(savePath, "PCA_4pts_activatedLRT.svg"), plot = last_plot())
ggsave(file.path(savePath, "PCA_4pts_activatedLRT.png"), plot = last_plot())
